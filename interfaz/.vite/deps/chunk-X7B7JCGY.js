...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React24.useState(idOverride);
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React35.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime10.jsxs)(React35.Fragment, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-X7B7JCGY.js.map
